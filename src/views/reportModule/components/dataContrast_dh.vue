          ...
          dataDian.forEach((item, index) => {
            if (
              ...
              if (lineObj.settlement) {
                str = `
              <div>
              <p>设备名称：${lineObj.name}</p>
              <p>倾角：${lineObj.offset} °</p>
              <p>位移：${lineObj.hDisplacement} mm</p>
              <p>沉降值：${lineObj.settlement} mm</p>
              <p>剩余电量：${lineObj.batteryVoltage*100}%</p>
              </div>
              `;
              } else {
                str = `
              ...
              <p>剩余电量：${lineObj.batteryVoltage?lineObj.batteryVoltage*100:"0"}%</p>
              </div>
              `;
              }
